...
/// Editor-wide fallback font used wherever measurement or overlay rendering needs a `Blob<u8>` and the
/// requested font has not been loaded yet. Backed by an embedded copy of Source Sans Pro Regular.
